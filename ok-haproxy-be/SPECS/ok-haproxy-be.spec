...
%define haproxy_version 1.5.9
%define ok_revision 01
...
#---------------------------------------------------------------------------------
%build
make TARGET=linux2628 PREFIX=%{haproxy_home} USE_PCRE=1 CPU=native ARCH=x86_64
...
%changelog
* Wed Dec 3 2014 Oleksiy Kovyrin <alexey@kovyrin.net> - haproxy-be-1.5.9-01
- Upgraded to the latest release from upstream.
- Added support for seprate reload/restart commands in the init script.
* Mon Jul 14 2014 Oleksiy Kovyrin <alexey@kovyrin.net> - haproxy-be-1.5.2-06
- Do not start the process if it already running
- Do not try to stop the process if it is down
* Mon Jul 14 2014 Oleksiy Kovyrin <alexey@kovyrin.net> - haproxy-be-1.5.2-05
