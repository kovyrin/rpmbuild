...
Patch0: check_procs.openvz_modified.patch
...
%prep
%setup
%patch0 -p1 -b .check_procs_openvz
...
%doc NEWS README REQUIREMENTS SUPPORT command.cfg
...
%changelog
* Thu Jul 24 2013 <vtonko@swiftype.net> - 1.4.16-10
- patched check_procs.c (added containers support)
